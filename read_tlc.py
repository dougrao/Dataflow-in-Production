...
def main():
    ...
    INPUT_PATH = "oci://<bucket>@<tenancy>/yellow_tripdata_2023-01.parquet"
    ...
    df_nyc_tlc = spark_session.read..parquet(INPUT_PATH, header=False, inferSchema=True)
    input_dataframe = df_nyc_tlc.groupBy("VendorID") \
